...
<html lang="en">
    <head>
        ...
        <!-- CSS files -->
        <link rel="stylesheet" href="./../assets/styles/form-for.css">
	</head>
    <body class="p-3 mb-2 bg-primary">
				...
				<div class="col">
					...
					<div class="card dark Content-Center" >
						<div class="card-body">
							...
							<br>
							<!-- Form -->
							<form action="./../forms/process-for.php" method="POST">
		...
		<!-- External Scripts -->
		<script type="text/javascript" src="./../assets/Scripts/form-for.js"> </script>
	</body>
</html>
