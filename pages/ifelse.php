...
<html lang="en">
    ...
    <body class="p-3 mb-2 bg-primary">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<a class="navbar-brand" href="#">Hola <?php echo $_SESSION['user']; ?>, ejemplo IF-ELSE</a>
		...
		<div class="card dark Content-Center" >
			<div class="card-body">
				<p class="h3 card-title center-block">Ingresa un número: </p>
				<br>
				<!-- Form -->
				<form action="./../forms/process-ifelse.php" method="POST">
					<div class="mb-1 input-container">
						<i class="fas fa-sort-numeric-up-alt"></i>
						<input type="number" name="number" id="number-parity" 
							min="-100000000" max="100000000" 
							class="form-control validate input-field"
                        	placeholder="Valor númerico">
                        <label data-error="wrong" data-success="right" for="number-parity"></label>
                    </div>
		...
		<!-- External Scripts -->
		<script type="text/javascript" src="./../assets/Scripts/form-ifelse.js"> </script>
	</body>
</html>
