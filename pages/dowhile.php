...
<html lang="en">
    ...
    <body class="p-3 mb-2 bg-primary">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<a class="navbar-brand" href="#">Hola <?php echo $_SESSION['user']; ?>, ejemplo DO-WHILE</a>
		...
		<div class="card dark Content-Center" >
			<div class="card-body">
				...
				<br>
				<!-- Form -->
				<form action="./../forms/process-dowhile.php" method="POST">
					<div class="mb-1 input-container">
						<i class="fas fa-sort-numeric-up-alt"></i>
						<input type="number" name="number" id="number-divide"
							min="1000" max="1000000" 
							class="form-control validate input-field"
                        	placeholder="Valor númerico">
                        <label data-error="wrong" data-success="right" for="number-divide"></label>
                    </div>
		...
		<!-- External Scripts -->
		<script type="text/javascript" src="./../assets/Scripts/form-dowhile.js"> </script>
	</body>
</html>
